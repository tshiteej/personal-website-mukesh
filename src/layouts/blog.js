...
export default function BlogLayout({ children, frontMatter }) {
  ...
  const shareUrl = "https://www.mukesh.com" + router.asPath
  const title = frontMatter.title
  const caption = frontMatter.summary
  const hashTags = frontMatter.tags.split(",").map((ele) => {
    return ele.trim().replace(/\s/, "_")
  })
  const related = "Mukesh"
  const source = "https://www.mukesh.com/"
  return (
    <>
      <Container>
        <Head>
          <title>{frontMatter.title} | Mukesh</title>
          ...
          <meta
            property="og:image"
            content="https://www.tshiteej.com/tb_50.png"
          />
            ...
            >
              <Flex align="center">
                <Avatar
                  ...
                  src="https://avatars.githubusercontent.com/u/35201954?v=4"
                  mr={2}
                />
